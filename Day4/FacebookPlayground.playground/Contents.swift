//FacebookClassChallenge
    ...
    class facebookProfile {
        ...
        init(Quote: String, numberOfFriends: String, relationship: String, status: String) {
    ...
    // (object: very specific cookie made out of cookie cutter)
    var marysFacebook = facebookProfile (Quote: "You're worth it", numberOfFriends: "1,000", relationship: "single", status: "coding right now")

print(marysFacebook.statusUpdate)
    ...
    //Step 0: Generate an initializer based on the variable properties and constant properties. (done)
